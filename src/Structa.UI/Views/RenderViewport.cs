...
public sealed class RenderViewport : OpenGlControlBase
{
    ...
    public RenderViewport()
    {
        ...
        _selection = new SelectionManager(App.Services.GetRequiredService<IEventAggregator>());

        // Conteúdo de teste: ainda não há ferramentas de desenho (Etapas 05/06), então estas malhas
        // existem só para validar o picking de vértice/aresta/face/objeto — o cubo cobre um sólido
        // convexo simples e a folha cobre um contorno côncavo com mais vértices.
